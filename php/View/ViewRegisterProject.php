...
<body>
	<div class="container" >
		...
		<!-- fim menu -->	
		<div id="principal">
			<h1 class="text-center">Register Project</h1>
			<form action="postCadastraProject" method="POST">
				<div class="row " >
					...
					<!-- <div class="col-md-6 center-block" style="margin-left: auto; margin-right: auto;"> -->
						...
						<select id="department" name="dep" class="form-control">
							<?php
...
<script>		
	$(document).ready(function () {
        $('.cadastrarProjeto').addClass('active');
    });
</script>